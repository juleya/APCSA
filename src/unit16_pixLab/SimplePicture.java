...
public class SimplePicture implements DigitalPicture
{
 ...
 public boolean load(String fileName)
 {
     ...
     try {
         this.loadOrFail(file);
         return true;

     } catch (Exception ex) {
         System.out.println("There was an error trying to open " + file);
         bufferedImage = new BufferedImage(600,200,
                                           BufferedImage.TYPE_INT_RGB);
         addMessage("Couldn't load " + file,5,100);
         return false;
     }
 ...
 {
	 String file = "src\\unit16_pixLab\\images\\" + fileName;
